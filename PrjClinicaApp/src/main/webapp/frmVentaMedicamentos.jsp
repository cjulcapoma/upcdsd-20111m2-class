		...
		<div id="header">
			<div class="container">
				...
				<ul class="nav">
					...
					<li><a href="frmRegistroConsultaMedica.jsp">Atención
							Consulta</a></li>
					<li><a href="frmVentaMedicamentos.jsp" class="current">Medicamentos</a>
					</li>
						...
						<div class="mainContent">
							<div class="section">
								...
								<div class="box">
									<div class="inner">
										<h4>
											Datos Reserva Mèdica<input type="button" class="button"
												value="Carga de datos temporal" onclick="javascript:carga()">
										</h4>
										<table width="100%">
											<tr>
											...
											<tr>
												...
												<td width="125px">${consulta.noPaciente}<input type="hidden" name="hdPaciente" ><input
													type="hidden" name="hdPaciente"></td>
												<td width="30px">&nbsp;</td>
												<td width="70px">D.N.I:</td>
												<td width="95px">${consulta.dniPaciente}<input type="hidden" name="hdDni" ><input
													type="hidden" name="hdDni"></td>
											</tr>
										</table>
										<br>
									...
									<div class="inner">
										...
										<table width="100%">
											...
											<tr>
												...
												<td width="240px" height="20px">Descuento: ${descuento}<input
													type="hidden" name="hdDescuento"></td>
											</tr>
											<tr>
												<td width="240px" height="20px">Monto Total a Pagar:
													${montoT}<input type="hidden" name="hdMontoT"></td>
												<td width="240px">Monto Pagado: <input type="text"
													size="8" name="efectivo">
												</td>
